// pthread_exit: finaliza la hebra 
// iniciar hebra en NULL: inicia con sus atributos por defecto (decisión del S.O) 
...
// estructura de pthread_create: (hebra, atributos, función, argumentos de la función)
