...
// Declaración e inicialización de la barrera, debe ser variable global
...
int main() {
    ...
    pthread_barrier_init(&barrera, NULL, NUM_THREADS); // estructura de barrera (dirección de memoria, atributos, número de hebras que deben pasar por la barrera)
